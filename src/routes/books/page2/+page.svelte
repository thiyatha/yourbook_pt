...
<div class="pagination">
  <a href="/books" class="btn btn-outline-danger btn-sm">1</a>
  <a href="/books/page2" class="btn btn-danger btn-sm">2</a>
</div>
...
<div class="book-grid">
  {#each books as book}
    <div class="book-card">
      ...
      <a href="/readlist" class="btn btn-outline-danger mt-2">Readlist</a>
    </div>
  {/each}
</div>
